<?php
	...
	if ($_POST["simpan"]<>"")
	{
		$qry_insert = "insert into fakultas (fakultas) values('".$_POST["fakultas"]."')";
...
<div class="card-body">
  <table cellpadding='0' cellspacing='0' width='100%' align='center'>
		<td>
			...
			<form method="POST" action="add_fakultas.php" >
			<tr>
				<td width='50%'>
					<strong>Fakultas : </strong><input type="text" class="form-control" name="fakultas">
				</td>
			</tr>
			<tr>
				<td width='50%'>
					...
					<form>
					<input type="button" class="btn btn-danger fa fa-trash-o" value="Kembali" onclick="window.location.href='view_fakultas.php'" />
					</form>
				</td>
			</tr>
			</form>
