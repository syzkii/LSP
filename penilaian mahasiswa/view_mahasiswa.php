<?
	...
	if ($_POST["simpan"])
	{
		...
		$q_simpan="insert into mahasiswa (nim,nama,alamat,no_telp,no_hp,hobi,id_jurusan) values ('".$nim."','".$nama."','".$alamat."','".$no_telp."','".$no_hp."','".$hobi."','".$id_jurusan."')";
  ...
  <table cellpadding='0' cellspacing='0' width='100%' align='center'>
	<tr>
		<td width='100%'>
			<br><br>
			<table width='100%'>
			<form method='post' action='view_mahasiswa.php'>
			<tr>
				<td>Cari Data
				<br><br>
				...
				<td width='50%' align='left'>
					...
					<a href='add_mahasiswa.php' class='btn btn-dark btn-kere2'><i class="fa fa-address-book-o">Tambah Data</a></i>
				</td>
			</tr>
			</form>
			</table>
			...
			if($_POST["cari"])
			{
				$sql_cari = "where (id like '%".$_POST["keyword"]."%' or nim like '%".$_POST["keyword"]."%' or nama like '%".$_POST["keyword"]."%' or alamat like '%".$_POST["keyword"]."%' or no_telp like '%".$_POST["keyword"]."%' or no_hp like '%".$_POST["keyword"]."%' or hobi like '%".$_POST["keyword"]."%' or id_jurusan like '%".$_POST["keyword"]."%') ";
			}
			$result = mysql_query("SELECT * FROM mahasiswa");

			$show = " select * from mahasiswa ".$sql_cari." ORDER BY id ";
			...
			while ($data = mysql_fetch_assoc($query))
				...
				<TR>
					...
					<TD><center>
						<a href='edit_mahasiswa.php?id=<?php echo $data["id"]; ?>' class="btn btn-warning"><i class="fa fa-edit">Edit</a></i>
						<a href='delete_mahasiswa.php?id=<?php echo $data["id"]; ?>' class="btn btn-danger"><i class="fa fa-eraser">Delete</a></i>
					</TD>
				</TR>				
				<?
					}
