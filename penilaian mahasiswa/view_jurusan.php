<?
	...
	if ($_POST["simpan"])
	{
		...
		$q_simpan="insert into jurusan (jurusan,id_fakultas) values ('".$jurusan."','".$id_fakultas."')";
  ...
  <table cellpadding='0' cellspacing='0' width='80%' align='center'>
	<tr>
		<td width='100%'>
			<br><br>
			<table width='100%'>
			<form method='post' action='view_jurusan.php'>
			<tr>
				<td>Cari Data
				<br><br>
				...
				<td width='50%' align='left'>
					...
					<a href='add_jurusan.php' class='btn btn-dark btn-kere2'><i class="fa fa-address-book-o">Tambah Data</a></i>
				</td>
			</tr>
			</form>
			</table>
			...
			if($_POST["cari"])
			{
				$sql_cari = "where (id like '%".$_POST["keyword"]."%' or jurusan like '%".$_POST["keyword"]."%' or id_fakultas like '%".$_POST["keyword"]."%') ";
			}
			$result = mysql_query("SELECT * FROM jurusan");

			$show = " select * from jurusan ".$sql_cari." ORDER BY id ";
			...
			while ($data = mysql_fetch_assoc($query))
				...
				<TR>
                    ...
                    <TD align='center'><?php echo $data["id_fakultas"];?></TD>

					<TD><center>
						<a href='edit_jurusan.php?id=<?php echo $data["id"]; ?>' class="btn btn-warning"><i class="fa fa-edit">Edit</a></i>
						<a href='delete_jurusan.php?id=<?php echo $data["id"]; ?>' class="btn btn-danger"><i class="fa fa-eraser">Delete</a></i>
					</TD>
				</TR>				
				<?
					}
